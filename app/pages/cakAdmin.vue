    ...
    <div class="relative z-10 w-full max-w-md">
      <div class="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border border-gray-200 dark:border-neutral-700 shadow-2xl rounded-2xl p-8">
        ...
        <form @submit.prevent="login" class="space-y-5">
          ...
          <!-- Button -->
          <button type="submit" :disabled="loading" class="w-full flex items-center justify-center gap-2 rounded-lg bg-blue-600 text-white px-4 py-2.5 text-sm font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 disabled:opacity-60 transition" >
