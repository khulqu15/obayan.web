...
const year = 2025 // fix nilai agar stabil di SSR; atau ambil dari runtimeConfig jika perlu
...
const footerBottomLinks = ref([{ label: 'Terms', href: '#' }, { label: 'Privacy', href: '#' }, { label: 'Status', href: '#' }])
